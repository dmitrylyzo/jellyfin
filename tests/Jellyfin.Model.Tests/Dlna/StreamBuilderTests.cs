...
namespace Jellyfin.Model.Tests
{
    public class StreamBuilderTests
    {
        ...
        [InlineData("Chrome-AudioTracksDefaultOnly", "mp4-h264-ac3-aac-srt-2600k", PlayMethod.Transcode, TranscodeReason.AudioCodecNotSupported, "DirectStream")]
        [InlineData("Chrome-AudioTracksDefaultOnly", "mp4-h264-ac3-aacDef-srt-2600k", PlayMethod.DirectPlay)]
        [InlineData("Chrome-AudioTracksDefaultOnly", "mp4-h264-ac3-aacExt-srt-2600k", PlayMethod.Transcode, TranscodeReason.AudioIsExternal)]
        [InlineData("Chrome-AudioTracksDefaultOnly", "mp4-h264-ac3-aac-aacDef-srt-2600k", PlayMethod.DirectPlay)]
        [InlineData("Chrome-AudioTracksDefaultOnly", "mp4-h264-ac3-srt-2600k", PlayMethod.Transcode, TranscodeReason.AudioCodecNotSupported, "DirectStream")]
        ...
        [InlineData("Chrome-AudioTracksDefaultOnly", "mkv-vp9-aac-srt-2600k", PlayMethod.Transcode, TranscodeReason.ContainerNotSupported, "Remux")]
        [InlineData("Chrome-AudioTracksDefaultOnly", "mkv-vp9-ac3-srt-2600k", PlayMethod.Transcode, TranscodeReason.ContainerNotSupported | TranscodeReason.AudioCodecNotSupported)]
        ...
        [InlineData("Chrome-AudioTracksDefaultOnly", "mp4-h264-aac-vtt-2600k", PlayMethod.DirectPlay)]
        [InlineData("Chrome-AudioTracksDefaultOnly", "mp4-h264-ac3-aac-srt-2600k", PlayMethod.Transcode, TranscodeReason.AudioCodecNotSupported, "DirectStream")]
        [InlineData("Chrome-AudioTracksDefaultOnly", "mp4-h264-ac3-aacDef-srt-2600k", PlayMethod.Transcode, TranscodeReason.AudioCodecNotSupported, "DirectStream")]
        [InlineData("Chrome-AudioTracksDefaultOnly", "mp4-h264-ac3-aacExt-srt-2600k", PlayMethod.Transcode, TranscodeReason.AudioCodecNotSupported, "DirectStream")]
        [InlineData("Chrome-AudioTracksDefaultOnly", "mp4-h264-ac3-srt-2600k", PlayMethod.Transcode, TranscodeReason.AudioCodecNotSupported, "DirectStream")]
        [InlineData("Chrome-AudioTracksDefaultOnly", "mp4-hevc-aac-srt-15200k", PlayMethod.Transcode, TranscodeReason.VideoCodecNotSupported, "Transcode")]
        [InlineData("Chrome-AudioTracksDefaultOnly", "mp4-hevc-ac3-aac-srt-15200k", PlayMethod.Transcode, TranscodeReason.VideoCodecNotSupported | TranscodeReason.AudioCodecNotSupported, "Transcode")]
        [InlineData("Chrome-AudioTracksDefaultOnly", "mkv-vp9-aac-srt-2600k", PlayMethod.Transcode, TranscodeReason.ContainerNotSupported, "Remux")]
        [InlineData("Chrome-AudioTracksDefaultOnly", "mkv-vp9-ac3-srt-2600k", PlayMethod.Transcode, TranscodeReason.ContainerNotSupported | TranscodeReason.AudioCodecNotSupported, "DirectStream")]
        [InlineData("Chrome-AudioTracksDefaultOnly", "mkv-vp9-vorbis-vtt-2600k", PlayMethod.DirectPlay)]
        // Firefox
        [InlineData("Firefox", "mp4-h264-aac-vtt-2600k", PlayMethod.DirectPlay)] // #6450
        [InlineData("Firefox", "mp4-h264-ac3-aac-srt-2600k", PlayMethod.Transcode, TranscodeReason.AudioCodecNotSupported, "DirectStream", "HLS.mp4")] // #6450
        ...
        // Chrome-AudioTracksDefaultOnly
        [InlineData("Chrome-AudioTracksDefaultOnly", "mp4-h264-ac3-aac-srt-2600k", PlayMethod.Transcode, TranscodeReason.SecondaryAudioNotSupported, "Remux")]
        [InlineData("Chrome-AudioTracksDefaultOnly", "mp4-h264-ac3-aac-aac-srt-2600k", PlayMethod.Transcode, TranscodeReason.SecondaryAudioNotSupported, "Remux")]
        [InlineData("Chrome-AudioTracksDefaultOnly", "mp4-h264-ac3-aac-aacDef-srt-2600k", PlayMethod.DirectPlay)]
        [InlineData("Chrome-AudioTracksDefaultOnly", "mp4-h264-ac3-aacExt-srt-2600k", PlayMethod.Transcode, TranscodeReason.AudioIsExternal)]
