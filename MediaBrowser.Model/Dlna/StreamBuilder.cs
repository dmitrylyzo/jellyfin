    ...
    public class StreamBuilder
    {
            ...
            var analyzedProfiles = transcodingProfiles
                .Select(transcodingProfile =>
                {
                        ...
                        && options.AllowAudioStreamCopy)
                    {
                        ...
                        {
                            var failures = GetCompatibilityAudioCodec(options, mediaSource, container, audioStream, transcodingAudioCodec, true, false, false);
        ...
        public void CheckCompatibility(MediaType mediaType, MediaSourceInfo mediaSource, MediaOptions options)
        {
            ...
            foreach (var stream in mediaSource.MediaStreams)
            {
                ...
                {
                    stream.DirectPlayErrors = GetCompatibility(mediaType, mediaSource, stream, options, profile.SingleAudioPolicy == null && audioCount > 0);
